    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSignUp.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view) {
                   ...
                   progressBar.setVisibility(View.VISIBLE);
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            data[2] = password;
                            data[3] = email;
                            PutData putData = new PutData("http://192.168.1.71/LoginRegister/signup.php", "POST", field, data);
                            if (putData.startPut()) {
                                if (putData.onComplete()) {
                                    progressBar.setVisibility(View.GONE);
                                    String result = putData.getResult();
                                    if (result.equals("Regisztracio sikeres!")){
                ...
                Toast.makeText(getApplicationContext(), "Minden mező kitöltése szükséges!", Toast.LENGTH_SHORT).show();
                }
